...
class DBMS
{
    ...
    public void SelectCount()
    {
        ...
        System.out.println("Number of records : "+iCnt);
    }
    ...
    public void SelectCount()
    {
        ...
        System.out.println("Summatiion of Marks column is : "+Sum);
    }
     ...
     public void SelectAvg()
     {
         ...
         System.out.println("Summatiion of Marks column is : "+(float)((float)Sum/(float)iCnt));
     }
      //select sum(Marks)from student
    public void SelectMax()
    {
     ...
     public void SelectStarFromName(String str)
     {
        ...
        System.out.println("Information of all student of name:"+str);
        while (temp!=null) 
 ...
 * 3:select * from where City ='_____';
 * 4:Select CountMarks from student :;
